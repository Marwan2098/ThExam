            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
                ...
                @if (auth('student')->check())
                    ...
                    @foreach ($notifications as $notification)
                                @php
                                    $quiz = $notification->model::find($notification->destination_id);
                                @endphp
                        <a href="{{ url('student/today-quizzes') }}" class="dropdown-item">{{ $notification->notification }}  <br> ( {{ $quiz->name }} )<small
                                class="float-right text-muted time">
                                Duration :  {{  $quiz->quiz_duration }}  min<br>
                                {{  $quiz->date_of_quiz }}
                            </small> </a>
                    @endforeach
                @else

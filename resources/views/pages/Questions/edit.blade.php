                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('Questions.update','test') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">correct Answers</label>
                                ...
                                <div class="form-row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="Grade_id">Quiz name <span
                                                    class="text-danger">*</span></label>
                                            <select class="custom-select mr-sm-2" name="quizze_id">
                                                <option selected disabled>Quiz Name...</option>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="score">
                                                ...
                                                <option value="5" {{$question->score == 2 ? 'selected':''}}>2</option>
                                                <option value="5" {{$question->score == 3 ? 'selected':''}}>3</option>
                                                <option value="5" {{$question->score == 4 ? 'selected':''}}>4</option>

                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="datetime-local" name="date_of_quiz" value="{{date('Y-m-d\TH:i',strtotime($quizz->date_of_quiz))}}" class="form-control pt-2">
                                        </div>
                                        <div class="col">
                                            <label for="title">{{trans('main_trans.quiz_duration')}}</label>
                                            <input type="number"  step="any" value="{{$quizz->quiz_duration}}"  name="quiz_duration" class="form-control pt-2">
                                        </div>
                                    </div>
                                </div><br>
